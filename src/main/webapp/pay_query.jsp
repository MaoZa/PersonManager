						...
						<ul class="pagination">
							<li>
								<c:if test="${payPageInfo.pageNum != 1 }">
									<a href="queryPay?pageNum=${payPageInfo.pageNum - 1 }" aria-label="Previous">
							...
							<c:forEach begin="1" end="${payPageInfo.pages}" var="i" step="1">
								<c:if test="${payPageInfo.pageNum == i }">
			               			<li><a href="queryPay?pageNum=${i}"><font color="red">${i}</font></a></li>
			               		</c:if> 
			             		<c:if test="${payPageInfo.pageNum != i }">
			               			<li><a href="queryPay?pageNum=${i}">${i}</a></li>
			               		</c:if> 
							</c:forEach>
							<li>
								<c:if test="${payPageInfo.pageNum != payPageInfo.pages }">
									<a href="queryPay?pageNum=${payPageInfo.pageNum + 1 }" aria-label="Next">
